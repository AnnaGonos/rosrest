...
export default function ContractsPage() {
  ...
  const [deletingItem, setDeletingItem] = useState<ContractDocument | null>(null)

  const [editModalOpened, setEditModalOpened] = useState(false)
  const [editingItem, setEditingItem] = useState<ContractDocument | null>(null)
  ...
  const loadDocuments = async () => {
    ...
    setError('')
    try {
      const res = await fetch(withCacheBust(API_ENDPOINTS.DOCUMENTS_LIST_BY_TYPE('contracts')), {
        cache: 'no-store',
  ...
  const openDeleteModal = (doc: ContractDocument) => {
    setDeletingItem(doc)
    setDeleteModalOpened(true)
  }

  const openEditModal = (doc: ContractDocument) => {
    setEditingItem(doc)
    setEditTitle(doc.title)
    setEditPdfUrl(doc.fileUrl || doc.pdfUrl || '')
  ...
  if (loading) {
    return (
      <DashboardLayout title="Соглашения РАР">
      ...
      <Container className="py-4">
        <div className="d-flex flex-column gap-4">
          <div className="mb-4 d-flex justify-content-between align-items-start gap-3">
            ...
            <a
              href="https://rosrest.com/contracts"
              target="_blank"
              rel="noopener noreferrer"
      ...
      >
        ...
        <Modal.Body>
          <div className="d-flex flex-column gap-3">
            ...
            <Form.Group controlId="contractTitle">
      ...
      >
        ...
        <Modal.Body>
          <div className="d-flex flex-column gap-3">
            ...
            <Form.Group controlId="editContractTitle">
            ...
            <Form.Group controlId="editContractUrl">
