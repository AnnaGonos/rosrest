...
export default function ServicesPage() {
    ...
    const getServicePublicUrl = (slug: string): string => {
            ...
            <Container>
                <div className="mb-4 d-flex justify-content-between align-items-start gap-3">
                    <div>
                        ...
                        <a href="https://docs.google.com/document/d/1n3v9BSDtbP3G8-KG8HrFI5ky5RY1lsnlV8Rs9R78YSI/edit?tab=t.0#heading=h.4496vog68f5r"
                            target="_blank"
                    ...
                    <a
                        href="https://rosrest.com/services"
                        target="_blank"
                        rel="noopener noreferrer"
                                    ...
                                    <Card.Body>
                                        ...
                                        <div className="d-flex justify-content-between align-items-center">
                                            ...
                                            <div className="btn-group">
                                                <Button
                                                    as="a"
                                                    href={getServicePublicUrl(service.page.slug)}
                                                    target="_blank"
                                                    rel="noopener noreferrer"
                                                    variant="outline-primary"
                                                    size="sm"
                                                    title="Открыть услугу на сайте"
