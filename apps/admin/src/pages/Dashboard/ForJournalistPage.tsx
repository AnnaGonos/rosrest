            ...
            <Container>
                <div className="mb-4 d-flex justify-content-between align-items-start gap-3">
                    <div>
                        ...
                        <p className="text-muted">Редактирование страницы</p>

                        <a href="https://docs.google.com/document/d/1n3v9BSDtbP3G8-KG8HrFI5ky5RY1lsnlV8Rs9R78YSI/edit?tab=t.0#heading=h.m49uulpducfq"
                            target="_blank"
