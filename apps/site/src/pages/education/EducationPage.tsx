            ...
            <div className="page__container page__container--27">
                ...
                <ContentSection columns={2}>
                    <a href="/education/srednee-professionalnoe-obrazovanie"
                        rel="nofollow"
                    >
                        <img className="education-image-banner" src={getFileUrl('/images/education/srednee-600x450.png') || ''} alt="Образование" />
                    </a>
                ...
                <ContentSection columns={2}>
                    <a target="_blank" rel="nofollow"
                        ...
                        <img className="education-image-banner" src={getFileUrl('/images/education/anketa-vypusknika-600x450.png') || ''} alt="Анкета выпускника" />
                    </a>
                    <a target="_blank" rel="nofollow"
                        href="https://docs.google.com/spreadsheets/d/1F78TcG9PUyOxldUDbMuhlWiGI8hMYQJ9SJzQ92cQLN0/edit?gid=0#gid=0">
                        <img className="education-image-banner" src={getFileUrl('/images/education/baza-vypusknikov-600x450.png') || ''} alt="Таблица выпускников" />
                    </a>
                </ContentSection>
            </div >
        </div >
