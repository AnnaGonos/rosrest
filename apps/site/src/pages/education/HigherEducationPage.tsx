...
export default function HigherEducationPage() {
  ...
  useEffect(() => {
    ...
    const load = async () => {
      ...
      setError('')
      try {
        const res = await fetch(`${API_BASE}/education?type=higher`)
    ...
    <div className="page-main">
      <div className="page__header">
        <Breadcrumbs
          items={[
            ...
            { label: 'Высшее профессиональное образование', isCurrent: true },
          ]}
        />
      </div>
      <div className="page__container">
        <div className="page__subheader">
          ...
          <h1 className="page-title">Высшее профессиональное образование</h1>
        </div>
      </div>
